      ...
      <main className="mx-auto w-full max-w-lg flex-1 px-4 pb-28 pt-5">
        ...
        {worker.cvUnlocked ? (
          ...
          <Card className="mt-4 flex items-start gap-3.5 border-colon-600/20 bg-colon-100/40 p-4">
            <Clock className="mt-0.5 h-5 w-5 shrink-0 text-colon-600" />
            <p className="flex-1 text-xs leading-relaxed text-navy-800/70">
        ...
        {!worker.cvUnlocked && whatsappHref && (
          <Card className="mt-3 flex items-center gap-3 border-cr-red-600/20 bg-cr-red-100/30 p-3.5">
            ...
            <p className="flex-1 text-xs leading-relaxed text-navy-800/70">
              ...
              WhatsApp y coordinamos el pago con tarjeta, sin esperar la revisión del SINPE.
            </p>
            <a
              href={whatsappHref}
              target="_blank"
              rel="noopener noreferrer"
              className="shrink-0 rounded-lg bg-cr-red-600 px-3 py-2 text-xs font-semibold text-white"
            >
              WhatsApp
            </a>
          </Card>
