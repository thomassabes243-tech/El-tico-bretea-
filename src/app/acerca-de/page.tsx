  ...
  return (
    <div className="flex min-h-full flex-1 flex-col">
      ...
      <main className="mx-auto w-full max-w-lg flex-1 px-4 pb-28 pt-5">
        <h1 className="text-xl font-extrabold tracking-tight text-navy-900">Acerca de El Tico Bretea</h1>
        <p className="mt-2 text-sm leading-relaxed text-navy-800/70">
          El Tico Bretea nace para ayudar al tico a conseguir trabajo de forma directa y
        ...
        <Card className="mt-4 flex items-start gap-3.5 p-4">
          <HeartHandshake className="mt-0.5 h-5 w-5 shrink-0 text-cr-red-600" />
          <div>
