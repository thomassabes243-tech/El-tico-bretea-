  ...
  return (
    <div className="flex min-h-full flex-1 flex-col items-center justify-center px-4 py-10">
      ...
      <Card className="mt-6 flex max-w-sm flex-col items-center gap-3 p-8 text-center">
        <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-cr-red-600/[0.09] text-cr-red-600">
        ...
        <Link href="/" className="text-xs font-semibold text-cr-red-600">
          Volver al inicio
        </Link>
      </Card>
    </div>
