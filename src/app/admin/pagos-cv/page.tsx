  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-navy-800/60">
        ...
        esa persona -- confirmá el código contra tu cuenta de SINPE Móvil antes de aprobar.
      </p>
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex shrink-0 flex-col gap-1.5">
                ...
                <form action={async () => { "use server"; await rejectCvClaim(c.id); }}>
                  <button
                    type="submit"
                    className="flex w-full items-center gap-1.5 rounded-lg border border-cr-red-600/25 px-2.5 py-1.5 text-xs font-semibold text-cr-red-600"
                  >
