export function PopocatepetlScene({ className }: { className?: string }) {
  return (
    <svg
      viewBox="0 0 800 300"
    ...
    >
      ...
      <rect width="800" height="300" fill="url(#popoForest)" />
      ...
      <g transform="translate(470 175)">
        ...
        <ellipse cx="-30" cy="10" rx="95" ry="55" fill="url(#popoLake)" />
