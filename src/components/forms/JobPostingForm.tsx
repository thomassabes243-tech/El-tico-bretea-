...
const STEPS: { title: string; fields: (keyof JobPostingFormValues)[] }[] = [
  ...
  { title: "Detalles del puesto", fields: ["contractType", "quantity", "salary", "schedule", "deadline", "isUrgent"] },
    ...
    >
      ...
      {step === 0 && (
        <div className="flex flex-col gap-4">
          <FieldWrapper label="Título del brete" htmlFor="title" error={errors.title?.message}>
          ...
          <FieldWrapper label="Ubicación" htmlFor="location" error={errors.location?.message}>
            <TextInput id="location" placeholder="Ej. San José, Heredia o 'Remoto'" {...register("location")} />
          </FieldWrapper>
